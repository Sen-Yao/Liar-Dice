...
if __name__ == "__main__":
    ...
    parser.add_argument("--opponent_confidence", type=int, default=2, help="启发式对手的挑战激进程度")
    parser.add_argument("--eval_interval", type=int, default=100, help="训练中快速评测的 episode 间隔")
    parser.add_argument("--eval_episodes", type=int, default=20, help="每次快速评测的对局数")
    parser.add_argument("--min_epsilon", type=float, default=0.05, help="探索率的最小值")
